    ...
    public partial class frm_Login : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string sql = "SELECT * FROM NhanVien Where Username = '"+
                ...
                txt_Password.Text+ "'";
            //Select * from NhanVien where Username = 'admin' and Password = '123'
            //Kết nối CSDL và truy vấn câu lệnh sql
            txt_sql.Text = sql;
            string connStr = "Data Source = DUCLONG-PC\\SQLEXPRESS;Initial Catalog=QLCuaHang; " +
            "User Id = sa; Password = 1";
            //string connStr = "Data Source = DUCLONG-PC\\SQLEXPRESS;Initial Catalog=QLCuaHang;Integrated Security = True;";
